...
### Three powers of JS
1. The ability to react to user interaction (clicks, scrolls, key presses, hovers)
2. The ability to add stuff to the page
3. The ability to fetch more information (make requests)
